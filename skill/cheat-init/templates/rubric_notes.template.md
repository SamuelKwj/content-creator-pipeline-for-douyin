...
>
> 完整生命周期协议见 [shared-references/observation-lifecycle.md](../../references/shared-references/observation-lifecycle.md)。
> 升级流程见 [shared-references/bump-validation-protocol.md](../../references/shared-references/bump-validation-protocol.md)。
...
> Cold-start 用户应该等权起步——见 [opinion-video-zero.md](../starter-rubrics/opinion-video-zero.md)。
...
> ```
>
> 删除规则见 [shared-references/observation-lifecycle.md](../../references/shared-references/observation-lifecycle.md)：被吸收为维度 → 删；被推翻 → 删。git history 是档案。
...
详见 [starter-rubrics/opinion-video-zero.md](../starter-rubrics/opinion-video-zero.md) 的"比率桶方案"段。
